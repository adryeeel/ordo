        ...
        <section className='py-8 sm:py-12'>
            <div className='mx-auto max-w-7xl px-5 sm:px-8'>
                <div className='relative overflow-hidden rounded-[2rem] bg-[#16352c] px-6 py-16 text-white sm:px-12 sm:py-20 lg:px-20 lg:py-24'>
                    <div className='absolute inset-0 bg-[radial-gradient(circle,rgba(255,255,255,0.14)_1px,transparent_1px)] [mask-image:radial-gradient(circle_at_80%_50%,black,transparent_70%)] bg-[size:32px_32px] opacity-25' />
                    <div className='relative grid gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-end'>
                        <div>
                            <p className='mb-5 text-[0.68rem] font-semibold tracking-[0.16em] text-[#9fe7c6] uppercase'>
                                Join early access
                            </p>
                            <h2 className='max-w-2xl text-4xl leading-[1.02] font-semibold tracking-[-0.055em] text-balance sm:text-5xl lg:text-6xl'>
