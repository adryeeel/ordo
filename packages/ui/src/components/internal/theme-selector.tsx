...
export function ThemeSelector() {
    ...
    return (
        <fieldset className='bg-muted/70 relative grid grid-cols-3 gap-1 rounded-2xl p-1 shadow-[inset_0_1px_3px_rgb(0_0_0/0.1),inset_0_-1px_0_rgb(255_255_255/0.55)] dark:shadow-[inset_0_1px_4px_rgb(0_0_0/0.45)]'>
